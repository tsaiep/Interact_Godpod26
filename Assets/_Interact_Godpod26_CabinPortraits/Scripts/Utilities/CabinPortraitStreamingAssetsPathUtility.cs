...
namespace CabinPortraits.Utilities
{
    public static class CabinPortraitStreamingAssetsPathUtility
    {
        ...
        public static bool TryBuildFilePath(string relativePath, out string fullPath)
        {
            ...
            {
                if (!normalizedRelativePath.StartsWith(streamingAssetsRoot, System.StringComparison.OrdinalIgnoreCase))
                {
                    return false;
                }
